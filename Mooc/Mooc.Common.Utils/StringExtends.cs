...
namespace Mooc.Common.Utils
{
    public static class StringExtends
    {
        ...
        public static string UrlEncodeChar(this string str)
        {

            return EncryptHelper.Base64Code(str);
        }

        public static string UrlDecodeChar(this string str)
        {

            return EncryptHelper.Base64Decode(str);
        }
        ...
        /// <returns>截取后的字符串加上（...）</returns>
        public static string GetStrSubstring(this string str, int length)
        {
        ...
        public static string ChangeLongNumber(this int? input, int f = 2)
        {
            ...
            return ChangeLongNumber(tmpcount, f);
        }
        /// <summary>
        /// 转换长数字
        /// </summary>
        ...
        /// <returns></returns>
        public static string GetCountStr(this object data, int RtnData)
        {
            int rtnData = RtnData;
            try
            {
                ...
                if (rtnData >= 10000)
                {
                    return (rtnData * 1.0 / 10000).ToString("0.00") + "w";
                }
            }
            catch
            {
